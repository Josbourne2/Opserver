CREATE TABLE [dbo].[Mon_Audits_Remote_Staging] (
...
GO
CREATE UNIQUE CLUSTERED INDEX [IXCL_Mon_Audits_Remote_Staging]
    ON [dbo].[Mon_Audits_Remote_Staging]([Id] ASC);


GO
CREATE NONCLUSTERED INDEX [NUQ_Mon_Audits_Remote_Staging]
    ON [dbo].[Mon_Audits_Remote_Staging]([event_time] ASC, [server_instance_name] ASC, [session_id] ASC)
